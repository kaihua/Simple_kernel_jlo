...
//CONN-EC-Coverity42595-01+[
    if (priv_cmd.total_len == INT_MAX) {
		ret = -EFAULT;
		goto exit;
    }
//CONN-EC-Coverity42595-01+]
...
//	command = kmalloc(priv_cmd.total_len, GFP_KERNEL);
	command = kmalloc(priv_cmd.total_len + 1, GFP_KERNEL); //CONN-EC-Coverity39574-01*
	if (!command)
	{
    ...
    command[priv_cmd.total_len] = '\0';  //CONN-EC-Coverity39574-01+
