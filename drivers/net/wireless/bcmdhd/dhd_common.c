...
wl_show_host_event(wl_event_msg_t *event, void *event_data)
{
	...
	snprintf(eabuf, sizeof(eabuf), "%02x:%02x:%02x:%02x:%02x:%02x", //MTD-CONN-CD-WIFI-COVERITY_39555-00*
	...
	case WLC_E_AUTH_IND:
		if (auth_type == DOT11_OPEN_SYSTEM)
			...
			snprintf(err_msg, sizeof(err_msg), "AUTH unknown: %d", (int)auth_type); //MTD-CONN-CD-WIFI-COVERITY_39555-01*
			auth_str = err_msg;
		}
...
int dhd_keep_alive_onoff(dhd_pub_t *dhd)
{
	...
	memset(&mkeep_alive_pkt, 0, sizeof(struct wl_mkeep_alive_pkt));  //MTD-CONN-CD-WIFI-COVERITY_39579-00+
...
{
	char* str = NULL; //*list_str; //MTD-CONN-CD-WIFI-COVERITY_39550-00*
	uint16 short_temp;
	uint32 int_temp;
	...
	str = *list_str; //MTD-CONN-CD-WIFI-COVERITY_39550-00+
...
{
	char* str = NULL; //*list_str; //MTD-CONN-CD-WIFI-COVERITY_39549-00*
	int idx = 0;
	...
	str = *list_str; //MTD-CONN-CD-WIFI-COVERITY_39549-00+
...
wl_iw_parse_ssid_list(char** list_str, wlc_ssid_t* ssid, int idx, int max)
{
	...
	for (str = *list_str; str != NULL; str = ptr) {
		...
		if (idx < max) {
			//MTD-CONN-CD-WIFI-COVERITY_39554-00*[
			//bcm_strcpy_s((char*)ssid[idx].SSID, sizeof(ssid[idx].SSID), str);
			strncpy((char*)ssid[idx].SSID, str, sizeof(ssid[idx].SSID)-1); //MTD-CONN-CD-WIFI-COVERITY_42574-01*
			//MTD-CONN-CD-WIFI-COVERITY_39554-00*]
