...
#include "f_serial.c"
//#include "f_acm.c"/*MTD-CONN-EH-USBPORTING-02-*/
#include "f_adb.c"
#include "f_ccid.c"
#include "f_mtp.c"
...
#if 0/*MTD-CONN-EH-USBPORTING-02-{*/
/* ACM */
...
#endif/*MTD-CONN-EH-USBPORTING-02-}*/
					...
					struct usb_composite_dev *cdev)
{
	...
	int i;
        const char *name[2];
        int nluns;//MTD-CONN-EH-PCCOMPANION-00+
	...
	config->fsg.vendor_name = "SONY";/*MTD-CONN-EH-USBPORTING-02+*/
	config->fsg.product_name = "Mass storage";/*MTD-CONN-EH-USBPORTING-02+*/
...
static struct android_usb_function *supported_functions[] = {
	...
	&adb_function,
	&ccid_function,
//	&acm_function,  /*MTD-CONN-EH-USBPORTING-02-*/
	&mtp_function,
	&ptp_function,
	&rndis_function,
	&mass_storage_function,
	&cdrom_function,//MTD-CONN-EH-PCCOMPANION-00+
	&accessory_function,
	NULL
};
